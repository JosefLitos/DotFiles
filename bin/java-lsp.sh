...
JAR="$HOME/.java/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/plugins/org.eclipse.equinox.launcher_*.jar"
GRADLE_HOME=$HOME/gradle /usr/lib/jvm/default/bin/java \
  ...
  -Xmx2G \
  -jar $(echo "$JAR") \
  -configuration "$HOME/.java/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/config_linux" \
