...
nmap('i', '<M-a>', "<C-o>:lua require'lspsaga.codeaction'.code_action()<CR>")
...
nmap('i', '<M-f>', "<C-o>:lua require'lspsaga.provider'.lsp_finder()<CR>")
nmap('n', '<M-I>', ":lua require'lspsaga.provider'.preview_definition()<CR>")
nmap('i', '<M-I>', "<C-o>:lua require'lspsaga.provider'.preview_definition()<CR>")
